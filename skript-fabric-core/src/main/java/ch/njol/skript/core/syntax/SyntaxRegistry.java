...
public final class SyntaxRegistry {
    ...
    /** Register condition to be tried first (e.g. platform "x is vector(a,b,c)" before generic "x is y"). */
    public void registerConditionFirst(String patternString, Function<CoreSkriptPattern.CoreMatchResult, ch.njol.skript.core.condition.Condition> factory) {
        conditions.add(0, new Entry<>(CorePatternCompiler.compile(patternString), factory));
    }

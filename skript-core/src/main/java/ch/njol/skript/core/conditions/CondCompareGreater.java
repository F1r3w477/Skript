...
/**
 * Condition: %number% is greater than %number%.
 */
public final class CondCompareGreater implements Condition {

    private final Expression<Object> leftExpr;
    private final Expression<Object> rightExpr;

    public CondCompareGreater(Expression<Object> leftExpr, Expression<Object> rightExpr) {
